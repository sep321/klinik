            ...
            <div class="overflow-x-auto flex justify-center">
                <table class="min-w-full bg-gray-800 border border-gray-700 rounded shadow">
                    <thead class="bg-gray-700 text-indigo-300">
                        <tr>
                            <th class="py-3 px-4 border border-gray-700" colspan="5">Table Daftar Registrasi</th>
                        </tr>
                    </thead>
                    <thead class="bg-gray-700 text-indigo-300">
                        <tr>
                    ...
                    <tbody>
                        @forelse ($regis as $index => $reg)
                            <tr class="text-center hover:bg-gray-700 transition">
                                ...
                                {{-- <td class="py-2 px-4 border border-gray-700">{{ $reg->tanggal_lahir }}</td>
                                <td class="py-2 px-4 border border-gray-700">{{ $reg->jenis_kelamin }}</td>
                                <td class="py-2 px-4 border border-gray-700">{{ $reg->no_hp }}</td> --}}
